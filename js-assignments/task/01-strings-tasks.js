    ...
    for (let i = 0; i < str.length; i++) {
        if (str.charCodeAt(i) > 64 && str.charCodeAt(i) < 91 ||
            str.charCodeAt(i) > 96 && str.charCodeAt(i) < 123) {
                if      (str.charCodeAt(i) <= 77)  { s[i] = String.fromCharCode( str.charCodeAt(i) + 13) }
                else if (str.charCodeAt(i) <= 90)  { s[i] = String.fromCharCode( str.charCodeAt(i) - 13) }
                else if (str.charCodeAt(i) <= 109) { s[i] = String.fromCharCode( str.charCodeAt(i) + 13) }
                else if (str.charCodeAt(i) <= 122) { s[i] = String.fromCharCode( str.charCodeAt(i) - 13) }
        }
